...
export const coreValues = [
  { title: "이동권", body: "휠체어를 옮겨타지 않고 앉은 채 뒷바퀴만\n교체하여 외출과 귀가시 두려움이 사라집니다." },
  { title: "고용권", body: "취약계층의 고용을 도와 적극적인 경제활동과 자립을 지원하는 일자리 제공형 예비사회적기업입니다." },
  { title: "안전과 청결", body: "낙상사고와 실내 오염, 호흡기 질환을 동시에 해결하는 유니버설 디자인 제품을 만듭니다." },
];
...
export const history: { year: string; items: HistoryItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { date: "2023. 12", title: "예비사회적기업 지정", desc: "고용노동부 일자리 제공형 (2023. 12 ~ 2026. 12)" },
  ...
  },
  {
    year: "2024",
    items: [
      { date: "2024. 01", title: "한국지체장애인협회 수원시지회 미팅", desc: "경기도의회, 수원시 4개구 시범사업 추진" },
  ...
  },
  {
    year: "2025",
    items: [
      { date: "2025. 03", title: "마이프렌드 지식재산권 등록", desc: "특허등록 3건, 디자인등록 3건, 상표등록 5건" },
      ...
      { date: "2025. 09", title: "성실경영평가 통과", desc: "2년 연속, 중소벤처기업부 확인증 (2025. 09 ~ 2028. 09)" },
      { date: "2025. 09", title: "경기 스타트업 아카데미 창업가 역량강화 교육 선정", desc: "경기도경제과학진흥원, 스케일업 과정" },
      { date: "2025. 10", title: "재도전 마인드업 힐링캠프 선정", desc: "중소벤처기업진흥공단, 힐링캠프" },
      { date: "2025. 11", title: "경기 스타트업 아카데미 · 재창업 특화교육 및 컨설팅", desc: "중소벤처기업진흥공단 우수선발자" },
      { date: "2025. 11", title: "경기 스타트업 아카데미 데모데이 최종 2위", desc: "창업가 역량 강화교육 우수선발자 2026 재도전 성공 패키지 1차 서류 면제 특전" },
    ],
  },
  {
    year: "2026",
    items: [
      { date: "2026. 03", title: "지식재산 긴급지원 사업 특허맵 선정", desc: "중소벤처기업부, 경기도, 지식재산처 경기대진테크노파크" },
      { date: "2026. 04", title: "재도전 성공 패키지 선정", desc: "중소벤처기업부, 창업진흥원, 서울창조경제혁신센터" },
    ],
  },
];
...
export const certificates = [
  ...
  { year: "2023", title: "예비사회적기업 지정", org: "고용노동부 · 사회적협동조합사랑과세상", image: "/images/cert/cert-1.jpg" },
  { year: "2024", title: "소셜벤처기업 판별", org: "중소벤처기업부", image: "/images/cert/cert-2.jpg" },
  { year: "2024~2025", title: "2년 연속 성실경영평가 통과", org: "중소벤처기업부 · 재도전 응원 본부", image: "/images/cert/cert-4.jpg" },
  ...
  { year: "2026", title: "재도전 성공 패키지 선정", org: "창업진흥원 · 서울창조경제 혁신센터", image: "/images/cert/cert-7.jpg" },
];
...
export const productFamily = [
  { name: "마이리프트", en: "MY LIFT", desc: "휠체어 휠 교체용 전동 리프트" },
  { name: "마이스포츠", en: "MY SPORTS", desc: "장애인 직장 운동 경기부 근태 · 훈련 · 경기 기록 앱" },
  { name: "마이바이크", en: "MY BIKE", desc: "수동 휠체어용 하이브리드 바이크" },
  { name: "마이프렌드", en: "MY FRIEND", desc: "사회적약자 돌봄 · 복지용품 플랫폼, 장애인 길안내" },
  { name: "마이에너지", en: "MY ENERGY", desc: "모니터링 가능한 전동보장구 충전소, 배터리 방문교환" },
  { name: "마이아이즈", en: "MY EYES", desc: "시각장애인 실시간 길안내 스마트 글래스" },
];
